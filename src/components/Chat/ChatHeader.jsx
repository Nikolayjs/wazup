  ...
  return (
    <div className="flex justify-between bg-[#202c33] px-4 py-2">
      <div className="flex flex-none space-x-2 items-center">
        {user.avatar ? (
          <img src={user.avatar} className="rounded-full h-12 w-12" alt="" />
        ) : (
          <svg
            viewBox="0 0 212 212"
            height="212"
        ...
        <div className="flex flex-col">
          <span className="font-bold text-[#e9edef]">{user.name}</span>
          <span className="text-sm text-[#aebac1]">был(-а) вчера в 21:21</span>
        </div>
      </div>
